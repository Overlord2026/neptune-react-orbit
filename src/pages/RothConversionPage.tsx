  ...
  return (
    <div className="container mx-auto py-8 space-y-6 px-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-6 gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Roth Conversion &amp; Multi-Year Planner</h1>
      ...
      <Card className="border-primary/20 shadow-xl">
        ...
        <CardContent className="p-0">
          ...
          >
            ...
            <TabsContent value="single-year" className="mt-0 px-4 pb-4">
              <SingleYearRothConversion />
            </TabsContent>
            <TabsContent value="multi-year" className="mt-0 px-4 pb-4">
