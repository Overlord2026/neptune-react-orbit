 ...
 * State Tax Data
 * 
 * Data containing tax bracket information for various US states.
 */
import { StateCode, StateTaxData } from './types';
...
// Create a lookup object for highest marginal rates by state
